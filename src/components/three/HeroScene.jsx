  ...
  return (
    <group ref={group}>
      <lineSegments>
        ...
        <lineBasicMaterial color="#2a6b78" transparent opacity={0.5} />
      </lineSegments>
      <points>
        <bufferGeometry>
          <bufferAttribute attach="attributes-position" args={[pointsPositions, 3]} />
        </bufferGeometry>
        <pointsMaterial color="#5ee7ff" size={0.06} sizeAttenuation transparent opacity={0.9} />
      </points>
    </group>
  )
}
    ...
    return (
      <div className="flex h-full w-full items-center justify-center">
        <div
          ...
          style={{ background: "radial-gradient(circle, rgba(94,231,255,0.25), transparent 70%)" }}
        />
      </div>
    )
  }
    ...
    <Suspense
      fallback={
        <div className="flex h-full w-full items-center justify-center">
          <div
            className="h-56 w-56 rounded-full blur-2xl"
            style={{ background: "radial-gradient(circle, rgba(94,231,255,0.2), transparent 70%)" }}
          />
        </div>
      }
    >
